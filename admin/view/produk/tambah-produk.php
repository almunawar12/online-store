                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <?php
                                                if(isset($_POST['save'])){
                                                    ...
                                                    $koneksi->query("INSERT INTO produk (nama_produk, harga_produk, berat, foto, ketersediaan_stok, deskripsi)
                                                    ...
                                                    echo "<meta https-equiv='refresh' content='1;url=produk.php'>";
